    ...
    public static class Detail implements Serializable{
        ...
        private boolean equalsEwpServiceCurrencySetting(DeployDetailEntry.Detail geaDetail){
            if (StringUtils.equals(this.getGeaServiceRefId(),geaDetail.getGeaServiceRefId())
                    ...
                    && Objects.equals(Double.valueOf(this.getAdminFee()),Double.valueOf(geaDetail.getAdminFee()))
                    && Objects.equals(Double.valueOf(this.getChangeNameAdminFee()),Double.valueOf(geaDetail.getChangeNameAdminFee()))
                    && Objects.equals(Double.valueOf(this.getCancelAdminFee()),Double.valueOf(geaDetail.getCancelAdminFee()))
                    ) {
                return true;
            }
            return false;
