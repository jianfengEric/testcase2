...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        .antMatchers("/login", "/login/loginCheck", "/login/syncToken", "/oauth/**", "/token/**", "/validCode/**", "/public/**",
                ...
                "/account/checkEmailDate","/account/checkResetPwdTime","/account/resetPassword", "/account/activationAccount",
                "/remote/**","/remote_delete_token/**", "/mamAccount/**","/participant/v1/download-material","/approval/v1/deploy","/base_service/v1/**");
    }
    @Override
