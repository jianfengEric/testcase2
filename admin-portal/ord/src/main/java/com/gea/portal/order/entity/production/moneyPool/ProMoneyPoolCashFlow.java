...
public class ProMoneyPoolCashFlow  implements Serializable {
  ...
  private ProMoneyPool moneyPool;
  ...
  public ProMoneyPool getMoneyPool() {
    return moneyPool;
  }

  public void setMoneyPool(ProMoneyPool moneyPool) {
