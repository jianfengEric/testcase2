...
public class PreGeaTxQueue implements Serializable {
	...
	@Column(name="SCREENING_REF_ID")
	private String screeningRefId;
	...
	private PreEwalletParticipant participant;

	@NotFound(action= NotFoundAction.IGNORE)
	@OneToOne()
	@JoinColumn(name = "QUOTATION_ID", insertable=false, updatable=false)
	private PreQuotation quotation;
	...
	public String getScreeningRefId() {
		return this.screeningRefId;
	}

	public void setScreeningRefId(String screeningRefId) {
		this.screeningRefId = screeningRefId;
	}
	...
	public PreEwalletParticipant getParticipant() {
		return participant;
	}

	public void setParticipant(PreEwalletParticipant participant) {
		this.participant = participant;
	}

	public PreQuotation getQuotation() {
		return quotation;
	}

	public void setQuotation(PreQuotation quotation) {
