...
public class ProQuotation implements Serializable {
  ...
  private ProTngIssuer tngIssuer;
  ...
  public ProTngIssuer getTngIssuer() {
    return tngIssuer;
  }

  public void setTngIssuer(ProTngIssuer tngIssuer) {
