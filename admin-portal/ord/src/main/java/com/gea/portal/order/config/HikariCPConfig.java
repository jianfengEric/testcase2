 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.tng.portal.ana.repository", "com.gea.portal.order.repository"})
public class HikariCPConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.tng.portal.ana.entity", "com.gea.portal.order.entity")
