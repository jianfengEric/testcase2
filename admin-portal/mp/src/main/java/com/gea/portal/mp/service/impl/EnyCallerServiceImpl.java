    ...
    public RestfulResponse<PageDatas<MoneyPoolTransactionDto>> getMoneyPoolDetailPageList(MoneyPoolDetailPageDto detailPageDto,Instance instance,Integer pageNo, Integer pageSize, String sortBy, Boolean isAscending) {
        ...
        if(StringUtils.isNotBlank(detailPageDto.getMoneyPoolId())){
            ...
            if(Objects.nonNull(ewpMoneyPool)){
                prams.put("moneyPoolId", ewpMoneyPool.getGeaMoneyPoolRefId());
            }
        }
        ...
        if(StringUtils.isNotBlank(detailPageDto.getTransactionDateTime())){
            prams.put("transactionDateTime",detailPageDto.getTransactionDateTime());
        }
        ...
        if(StringUtils.isNotBlank(detailPageDto.getAmount())){
            prams.put("amount",detailPageDto.getAmount());
        }
        if(StringUtils.isNotBlank(detailPageDto.getBalanceBeforeTransaction())){
            prams.put("beforeTotalBalance",detailPageDto.getBalanceBeforeTransaction());
        }
        if(StringUtils.isNotBlank(detailPageDto.getBalanceAfterTransaction())){
            prams.put("afterTotalBalance",detailPageDto.getBalanceAfterTransaction());
        }
