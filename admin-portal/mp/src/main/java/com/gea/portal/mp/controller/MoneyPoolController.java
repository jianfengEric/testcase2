...
public class MoneyPoolController {
    ...
    public RestfulResponse<PageDatas<MoneyPoolTransactionDto>> listMoneyPoolDetailPageList(@ApiParam(value = "moneyPoolId") @RequestParam(required = true) String moneyPoolId,
                                                                                   ...
                                                                                   @ApiParam(value = "transactionDateTime") @RequestParam(required = false) String transactionDateTime,
                                                                                   @ApiParam(value = "currency") @RequestParam(required = false) String currency,
                                                                                   @ApiParam(value = "serviceType") @RequestParam(required = false) String serviceType,
                                                                                   @ApiParam(value = "transactionType") @RequestParam(required = false) String transactionType,
                                                                                   @ApiParam(value = "amount") @RequestParam(required = false) String amount,
                                                                                   @ApiParam(value = "balanceAfterTransaction") @RequestParam(required = false) String balanceAfterTransaction,
                                                                                   @ApiParam(value = "balanceBeforeTransaction") @RequestParam(required = false) String balanceBeforeTransaction,
                                                                                   @ApiParam(value = "page size") @RequestParam(required = false, defaultValue = "10") Integer pageSize,
                                                                                   @ApiParam(value = "current page number") @RequestParam(required = false, defaultValue = "1") Integer pageNo,
                                                                                   @ApiParam(value = "instance") @RequestParam(required = false) Instance instance,
                                                                                   @ApiParam(value = "sort By") @RequestParam(required = false) String sortBy,
        ...
        moneyPoolDetailPageDto.setTransactionDateTime(transactionDateTime);
        moneyPoolDetailPageDto.setCurrency(currency);
        moneyPoolDetailPageDto.setServiceType(serviceType);
        moneyPoolDetailPageDto.setTransactionType(transactionType);
        moneyPoolDetailPageDto.setAmount(amount);
        moneyPoolDetailPageDto.setBalanceBeforeTransaction(balanceBeforeTransaction);
        moneyPoolDetailPageDto.setBalanceAfterTransaction(balanceAfterTransaction);
    ...
    public RestfulResponse<PageDatas<MoneyPoolTransactionDto>> getTransactionEnquiry(
    		...
    		@ApiParam(value = "transactionType") @RequestParam(required = false) String transactionType,
    		@ApiParam(value = "amount") @RequestParam(required = false) String amount,
    		@ApiParam(value = "balanceAfterTransaction") @RequestParam(required = false) String afterTotalBalance,
    		@ApiParam(value = "balanceBeforeTransaction") @RequestParam(required = false) String beforeTotalBalance,
        ...
        moneyPoolDetailPageDto.setTransactionType(transactionType);
        moneyPoolDetailPageDto.setAmount(amount);
        moneyPoolDetailPageDto.setBalanceBeforeTransaction(beforeTotalBalance);
        moneyPoolDetailPageDto.setBalanceAfterTransaction(afterTotalBalance);
